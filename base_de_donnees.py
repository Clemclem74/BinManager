...
def stockDonneesPleinVide(poubelle, temps):
	...
	requests.post('https://docs.google.com/forms/d/e/1FAIpQLSei5ygsYkcSmhMgWVwfSCcaVQQ4UNeeNVcOqjRrgUHTWjVm6g/formResponse', data = {'entry.1606041453':poubelle, 'entry.2022895418':temps} ,verify=False)
